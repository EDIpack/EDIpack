...
inequivalent impurities case. Standard Fortran interfaces are then used to group
all the procedures (from :f:mod:`edipack` and :f:mod:`edipack2ineq`) under the same
name.      
