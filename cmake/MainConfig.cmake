...
IF (CMAKE_INSTALL_PREFIX_INITIALIZED_TO_DEFAULT)
  IF (LONG_PREFIX)
    ...
    IF( (NOT GIT_BRANCH MATCHES "master") )
      SET(PATH_ID  "${PATH_ID}/${GIT_BRANCH}" CACHE INTERNAL "Default Path ID" FORCE)
    ENDIF()
    #IF DEBUG, add /debug to
    IF("${BUILD_TYPE}" MATCHES "debug")
      SET(PATH_ID  "${PATH_ID}/${BUILD_TYPE}" CACHE INTERNAL "Default Path ID" FORCE)
    ENDIF()
    ...
    SET(FULL_VER "${PATH_ID}/${VERSION}" CACHE INTERNAL "Default Path ID" FORCE)
  ELSE()
