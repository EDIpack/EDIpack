...
INSTALL(FILES ${TMP_CONFIGVARS_USER_FILE} DESTINATION ${LIB_TARGET_BIN}/
  PERMISSIONS ${PERMISSION_755} SETUID)
...
#Only Files:
INSTALL(FILES ${LIB_TARGET_ETC}/${EDI}.pc        DESTINATION $ENV{HOME}/.pkgconfig.d/ PERMISSIONS ${PERMISSION_755} SETUID)
INSTALL(FILES ${LIB_TARGET_ETC}/${EDI_C}.pc      DESTINATION $ENV{HOME}/.pkgconfig.d/ PERMISSIONS ${PERMISSION_755} SETUID OPTIONAL)
